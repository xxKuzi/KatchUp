...
const FlipCardsPage = () => {
  ...
  const startLiveMatch = () => {
    ...
    router.push(`/games/flip-cards/play?${params.toString()}`);
  };
  ...
  return (
    <GamePage
      name="Flip Cards Arena"
      description="Race another player in a live word challenge. You both receive the same 10 questions in different order. First to finish wins."
